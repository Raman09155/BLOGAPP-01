...
const { generateBlogPost, generateBlogPostIdeas, generateCommentReply, generatePostSummary, generateMetaData } = require("../controllers/aiController");
...
router.post("/generate-meta", protect, generateMetaData);
