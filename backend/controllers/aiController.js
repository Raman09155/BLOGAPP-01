...
// @desc Generated Blog post ideas from title
...
const generateCommentReply = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: "Failed to generate blog Post comment reply",
      error: error.message,
    });
  }
};
...
// @desc Generate meta data for blog post
// @route POST /api/ai/generate-meta
// @access Private
