...
const BlogPostView = () => {
  ...
  const updateMetaTags = (blogData) => {
    ...
    // Update title
    document.title = `${blogData.metaTitle || blogData.title} | Your Blog`;
    ...
    // Basic meta tags
    updateMetaTag('description', blogData.metaDescription || blogData.title);
    updateMetaTag('keywords', blogData.metaKeywords || blogData.tags?.join(', ') || '');
    
    // Open Graph tags
    updateMetaTag('og:title', blogData.metaTitle || blogData.title, 'property');
    updateMetaTag('og:description', blogData.metaDescription || blogData.title, 'property');
    updateMetaTag('og:image', blogData.coverImageUrl, 'property');
  ...
  const fetchPostDetailsBySlug = async () => {
    try {
      ...
      if (response.data) {
        ...
        updateMetaTags(data); // Update meta tags
          ...
          <div className="grid grid-cols-12 gap-8 relative">
            <div className="col-span-12 md:col-span-8 relative">
              ...
              <LikeCommentButton
                ...
                userHasLiked={blogPostData.likedByCurrentUser || false}
              />
            </div>
