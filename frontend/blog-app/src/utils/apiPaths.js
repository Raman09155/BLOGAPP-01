...
export const API_PATHS = {
  ...
  AI: {
    ...
    GENERATE_META_DATA: "/api/ai/generate-meta", // Generate meta data using AI
  },
  ...
  POSTS: {
    ...
    GET_BY_SLUG: (slug) => `/api/posts/slug/${slug}`, // Get a simple blog post by slug
    UPDATE: (id) => `/api/posts/${id}`, // Update a blog post (Admin Only)
