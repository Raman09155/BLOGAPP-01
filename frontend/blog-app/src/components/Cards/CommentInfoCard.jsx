          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 mt-1.5">
                {!isSubReply && (
                  <>
                    ...
                    <button
                     ...
                     text-sky-950 bg-sky-50 px-4 py-0.5 rounded-full hover:bg-sky-500 hover:text-white cursor-pointer"
                      onClick={() =>
                ...
                <button
                  className="flex items-center gap-1.5 text-[13px] font-sky-950 bg-sky-50 px-4 py-0.5 rounded-full hover:bg-rose-500 hover:text-white cursor-pointer"
                  onClick={() => onDelete()}
                >
                  <LuTrash2 /> Delete
                </button>
